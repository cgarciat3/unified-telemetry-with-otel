...
LOG_FILE = "/var/log/elk_app/elk_app.log"
...
def process_transaction(total: int, fail_rate: float = 0.3, mult: int = 5):
...
def maintenance_task(mult: int = 5):
    ...
    return {"status": "done", "req_id": request_id_var.get()}
